...
from .views.users import UsersView, UsersDevicesView, RegisterUserView, VerifyAccountView, RegisterGoogleUserView, ResendOTPView
from .views.update_password import UpdatePasswordView
from .views.login import LoginView, GoogleLoginView
...
urlpatterns = [
    ...
    path('verify/', VerifyAccountView.as_view(), name='verify-user'),
    path('glogin/', GoogleLoginView.as_view(), name='google-token-obtain-pair'),
    path('register-google/', RegisterGoogleUserView.as_view(), name='register-google-user'),
    path('login/', LoginView.as_view(), name='token-obtain-pair'),
    path('upload-id/', UsersView.as_view({'post': 'upload_id'}), name='upload-id'),
